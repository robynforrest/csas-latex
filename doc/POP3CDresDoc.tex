...
% master.tex - idea is to run   latex master.tex   on this file,
%  which calls in the other files:
%   preamble.tex - Table of Contents, Abstract etc.
%   main.tex - main text, figures and tables (and bibliography).
%   appendixExample.tex - an example appendix - just create more
%    of these. 
%  So COMMENT OUT \input{filename} when not working on filename.tex
