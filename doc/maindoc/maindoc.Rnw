...
\begin{tabular}{lcc}
\hline
Sensitivity & Description                                   & Parameters \\
\hline
1           & Reference Case                                & See Table \ref{tab:ParameterPriors} \\
2           & Decrease $\sigma$ to 0.1                      & $\vartheta=1.538$; $\rho=0.015$ \\
3           & Estimate Total Variance                       & $\vartheta$ estimated; $\rho=0.059$ \\
4           & Increase $\tau$ to 1.0                        & $\vartheta=0.962$; $\rho=0.038$ \\
5           & Decrease $\tau$ to 0.6                        & $\vartheta=2.500$; $\rho=0.100$ \\
...
12          & Selectivity Ogive = Maturity Ogive            & $sel$ = 4.99 yrs; $sel_g$ = 1.27 yrs \\
13          & Age-at-50\%-harvest set to 6 yrs              & $sel$ = 6.00 yrs; $sel_g$ = 1.00 yrs \\
\hline
\end{tabular}
\end{table}
...
\tiny
\centering
\caption{\label{tab:SensitivitiesToQ}Sensitivity cases for $q_k$; posterior quantiles. For sensitivity case descriptions, see table \ref{tab:Sensitivities}.}
\begin{tabular}{lcccccc}
\hline
Index  & \multicolumn{3}{c}{Sensitivity 10} & \multicolumn{3}{c}{Sensitivity 11} \\
\hline
 $q_k$ & 2.5\% & 50\% & 97.5\%              & 2.5\% & 50\% & 97.5\%               \\
\hline
...
makeTable(1, 1, ci=ci, burnthin=burnthin, digits=3, retxtable=TRUE, xcaption="Leading parameter estimates", xlabel="tab:ParamEst")
@
<<results='asis', echo=FALSE>>=
makeTable(1, 2, ci=ci, burnthin=burnthin, digits=3, retxtable=TRUE, xcaption="Reference points", xlabel="tab:RefPoints")
@
<<results='asis', echo=FALSE>>=
makeTable(1, 3, ci=ci, burnthin=burnthin, digits=3, retxtable=TRUE, xcaption="Spawning Biomass", xlabel="tab:spawnbiomass")
@
<<results='asis', echo=FALSE>>=
makeTable(1, 9, ci=ci, burnthin=burnthin, digits=3, retxtable=TRUE, xcaption="Relative Spawning Biomass", xlabel="tab:depletion")
@
<<results='asis', echo=FALSE>>=
makeTable(1, 4, ci=ci, burnthin=burnthin, digits=3, retxtable=TRUE, xcaption="Recruitment", xlabel="tab:recruitment")
@
<<results='asis', echo=FALSE>>=
makeTable(1, 5, ci=ci, burnthin=burnthin, digits=3, retxtable=TRUE, xcaption="Fishing mortality (F)", xlabel="tab:F")
@
<<results='asis', echo=FALSE>>=
makeTable(1, 6, ci=ci, burnthin=burnthin, digits=3, retxtable=TRUE, xcaption="Fishing mortality (U)", xlabel="tab:U")
@
<<results='asis', echo=FALSE>>=
# Note that the first column will not be set to have any decimal digits because it is the TAC/Catch projection
cap <- "Decision Table for the Reference Case model showing posterior probabilities that 2016 projected biomass $B_t$ is below a set of candidate reference points and benchmarks (Table \\ref{tab:RefPoints}), and probabilities that the 2015 projected harvest rate $U_t$ is above $U_{2014}$ or $U_{MSY}$."
makeTable(1, 7, ci=ci, burnthin=burnthin, digits=3, retxtable=TRUE, xcaption=cap, xlabel="tab:Decisions")
@
<<results='asis', echo=FALSE>>=
# Note that the first column will not be set to have any decimal digits because it is the TAC/Catch projection
cap <- "Decision Table for a sensitivity model (Selectivity = Maturity, Table \\ref{tab:Sensitivities}) showing posterior probabilities that 2016 projected biomass $B_t$ is below a set of candidate reference points and benchmarks (Table \\ref{tab:RefPoints}), and probabilities that the 2015 projected harvest rate $U_t$ is above $U_{2014}$ or $U_{MSY}$."
makeTable(12, 7, ci=ci, burnthin=burnthin, digits=3, retxtable=TRUE, xcaption=cap, xlabel="tab:DecisionsSelMat")
@
<<results='asis', echo=FALSE>>=
makeTable(1, 8, ci=ci, burnthin=burnthin, digits=3, retxtable=TRUE, xcaption="Input indices", xlabel="tab:Indices")
@
