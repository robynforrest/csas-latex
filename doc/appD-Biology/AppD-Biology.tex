...
\subfloat[]{\includegraphics[width=5.7in,keepaspectratio=true]{appD-Biology/lwmaleOptionA.eps}}
\newline
%\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/lwfemaleOptionA.png}}
\subfloat[]{\includegraphics[width=5.7in,keepaspectratio=true]{appD-Biology/lwfemaleOptionA.eps}}
\end{center}
\vspace{-10mm}
...
%\subfloat[]{\includegraphics[angle=90, width=6in,keepaspectratio=true]{appD-Biology/lwmaleCompare.eps}}
\newline
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/lwfemaleCompare.png}}
%\subfloat[]{\includegraphics[angle=90, width=6in,keepaspectratio=true]{appD-Biology/lwfemaleCompare.eps}}
\end{center}
