...
We used stage 3 (Developing) and higher to define mature females, leaving stages 1 and 2 for immature Arrowtooth Flounder. The number of mature females relative to the total number of valid otolith observations at each age was used as the data observation for each age (Equation~\ref{eq:matage1}). These proportions were fitted to a “double-normal” (half-Gaussian) function where the right-hand limb was constrained such that maturity equalled 1.0 when the age was greater than (Equation~\ref{eq:matage2}):
...
\begin{center}
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/lwmaleOptionA.png}}
\newline
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/lwfemaleOptionA.png}}
\end{center}
...
\captionsetup[subfigure]{labelformat=empty}
\begin{center}
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/lwmaleOptionB.png}}
\newline
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/lwfemaleOptionB.png}}
\end{center}
...
\captionsetup[subfigure]{labelformat=empty}
\begin{center}
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/lwmaleOptionC.png}}
\newline
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/lwfemaleOptionC.png}}
\end{center}
...
\captionsetup[subfigure]{labelformat=empty}
\begin{center}
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/lwmaleOptionD.png}}
\newline
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/lwfemaleOptionD.png}}
\end{center}
...
\captionsetup[subfigure]{labelformat=empty}
\begin{center}
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/lwmaleCompare.png}}
\newline
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/lwfemaleCompare.png}}
\end{center}
...
\captionsetup[subfigure]{labelformat=empty}
\begin{center}
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/vonbmale.png}}
\newline
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/vonbfemale.png}}
\end{center}
...
\captionsetup[subfigure]{labelformat=empty}
\begin{center}
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/vonbmaleCompare.png}}
\newline
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/vonbfemaleCompare.png}}
\end{center}
...
\captionsetup[subfigure]{labelformat=empty}
\begin{center}
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/maturityResearch.png}}
\newline
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/maturityCommercial.png}}
\end{center}
...
\captionsetup[subfigure]{labelformat=empty}
\begin{center}
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/maturityfitConstrainedMonths.png}}
\newline
\subfloat[]{\includegraphics[bb=0 0 925 600,width=6in,keepaspectratio=true]{appD-Biology/maturityfitAllMonths.png}}
\end{center}
\vspace{-8mm}
