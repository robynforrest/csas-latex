...
Here we present the parameterisation of the weights-at-age and female maturity. These are taken from our Pacific Ocean Perch assessment for Queen Charlotte Sound \citep{Edwards-etal:2012pop}; the same values are used for the companion assessment \citep{\otherCite} for area \other.

\section{Parameterisation of weights-at-age}

The estimates of weights-at-age are the same as those used in \citet{Edwards-etal:2012pop}. The average weight of an individual of age-class $a$ of sex $s$ is denoted $w_{as}$ (Appendix F), and is given by
\eb
