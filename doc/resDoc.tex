...
% fishname - Common name of the species being assessed
...
%\input{appC-Surveys/AppC-Surveys}

%\rfoot{Appendix C -- CPUE Analyses}
% Gave up because Paul won't give me the figures in eps format.
%\input{appC-CPUE/AppC-CPUE}
...
\rfoot{Appendix E -- Age Composition weighting}
% DONE
%\input{appE-AgeCompWeighting/AppE-AgeCompWeighting}
