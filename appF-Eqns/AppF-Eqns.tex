...
The model structure is the same as that used previously, and, as for the Yellowmouth Rockfish assessment, we used the weighting scheme of \citet{fran11} desribed below. The same methodology is used in the companion POP assessment for area \other~\citep{\otherCite}, but with different input data for commercial catch, survey indices and age compositions.
